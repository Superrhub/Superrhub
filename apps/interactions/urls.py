...
urlpatterns = [
    ...
    path('comment/<str:comment_id>/report/', views.report_comment, name='report_comment'),
    ...
    path('register/pay/', views.pay_to_register, name='pay_to_register'),
    path('register/verify/', views.verify_registration_payment, name='verify_registration_payment'),
