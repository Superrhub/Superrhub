...
urlpatterns = [
    ...
    path('stories/upload-cover/', views.upload_cover_image, name='upload_cover'),
    ...
    path('stories/<str:story_id>/chapters/<int:chapter_number>/edit/', views.edit_chapter_view, name='edit_chapter'),
    path('stories/<str:story_id>/chapters/<int:chapter_number>/delete/', views.delete_chapter_view, name='delete_chapter'),
